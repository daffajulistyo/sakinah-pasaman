...
import { getListMonitorDataKinerjaOpd } from '@/redux/ducks/monitoring/action'
import { getDatamasterOpd } from '@/redux/ducks/datamasteropd/action'
import { useParams, Link } from 'react-router-dom'

const MonitorDataKinerjaOpd = () => {
    ...
    const getDataTable = async () => {
        let response = await dispatch(getListMonitorDataKinerjaOpd({ master_opd_id: idopd }))
            ...
            <div className="bg-white h-auto dark:bg-gray-800 rounded-lg drop-shadow-xl py-1 px-3 w-full">
                <div className="dark:text-white">
                    <div className="flex flex-row items-center gap-3">
                        ...
                        <div className="lg:text-lg font-bold text-teal-500 dark:text-white">Laporan Data Kinerja Perangkat Daerah</div>
                    </div>
                </div>
            </div>
                ...
                <div className="block w-full p-4">
                    <StaticTable header={tableHeader()}>
                    {
                        ...
                        <tr className="border-b dark:border-gray-700">
                            ...
                            monitoringState.data_kinerja.length > 0 ?  
                            renderTujuan(monitoringState.data_kinerja)
                            :
                            <tr className="border-b dark:border-gray-700">
                                <td colSpan="100%" className="px-4 py-3 border text-center">No Data</td>
                            </tr>
...
export default MonitorDataKinerjaOpd