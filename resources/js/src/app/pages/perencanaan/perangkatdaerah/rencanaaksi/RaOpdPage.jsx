...
import { createRenaksiOpd, getListRenaksiOpd } from '@/redux/ducks/renaksiopd/action'
...
const RaOpdPage = () => {
    ...
    const getDataTable = (tahun = "") => {
        dispatch(getListRenaksiOpd({tahun: tahun !== "" ? tahun : selectedYear }))
    }
    React.useEffect(() => {
        getDataTable()
    },[])
    React.useEffect(() => {
        initFlowbite()
    },[renaksiOpdState.list]) //renaksiKdhState.list
    ...
    const download = async () => {
        try {
            ...
            const apiUrl = `${BASE_HOST_URL}/v1/opd/aksi/cetak?tahun=${selectedYear}`
            ...
            let filename = 'Rencana_Aksi_Perangkat_Daerah.pdf'; //    fallback filename
            if (disposition) {
        ...
        <Layout>
            ...
            <div className="bg-white h-auto dark:bg-gray-800 rounded-lg drop-shadow-xl py-1 sm:px-3 px-1 w-full flex flex-col lg:min-h-[35rem]">
                <div className="block w-full p-4">
                    ...
                    <div className="flex">
                        <PrimaryLinkBtn to={`/perencanaan/opd`}>
                ...
                <div className="block w-full p-4">
                    ...
                    {
                        renaksiOpdState.list.map((item, key) => (
                            <>
                                ...
                                <td className="px-4 py-3 border text-center align-top">
                                    ...
                                    <div id={`toggle-btn${key}`}
                                        ...
                                        <ul className="py-1 text-sm text-gray-700 dark:text-gray-200"
                                            ...
                                            <li>
                                                <Link to={`/perencanaan/opd/ra/langkah?sasaranid=${item.id}&indikatorid=${item.indikator_sasaran[0]?.id ?? "0"}&tahun=${selectedYear}`}
                                                    className="flex gap-1 py-2 px-4 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white">
                                                    <PencilSquareIcon className='w-4 h-4' />
                                                    Input Langkah
                                                </Link>
                                                    ...
                                                    <td className="px-4 py-3 border text-center align-top">
                                                        ...
                                                        <div id={`toggle-btn${val.id}`}
                                                            ...
                                                            <ul className="py-1 text-sm text-gray-700 dark:text-gray-200"
                                                                ...
                                                                <li>
                                                                    <Link to={`/perencanaan/opd/ra/langkah?sasaranid=${item.id}&indikatorid=${val.id}&tahun=${selectedYear}`}
                                                                        className="flex gap-1 py-2 px-4 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white">
                                                                        <PencilSquareIcon className='w-4 h-4' />
                                                                        Input Langkah
                                                                    </Link>
