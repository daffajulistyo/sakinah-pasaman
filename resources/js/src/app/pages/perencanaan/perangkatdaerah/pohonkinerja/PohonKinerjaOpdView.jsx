...
import { getListPohonKinerjaOpd } from '@/redux/ducks/pohonkinerjaopd/action';

const PohonKinerjaOpdView = () => {
    const dispatch = useDispatch()
    const pohonKinerjaOpdState = useSelector((state) => state.pohonKinerjaOpdState)
    React.useEffect(() => {
        dispatch(getListPohonKinerjaOpd())
    },[])

    const chartData = () => {
        let data = null
        try {
            if(pohonKinerjaOpdState.data !== null){
                const pkOpd = pohonKinerjaOpdState.data
                ...
                data = {
                    ...
                    name: renderMisi("Pohon Kinerja Perangkat Daerah", "1", "asdasd-asdasdasd-asdasd"),
                    children: tujuan
                }
            }
            ...
            <div className="bg-white h-auto dark:bg-gray-800 rounded-lg drop-shadow-xl py-5 px-4 w-full flex min-h-[35rem]">
                <div className="flex flex-col">
                    ...
                    <div className="w-full flex">
                        ...
                        <Link 
                            to={'/perencanaan/opd/pohonkinerja/tujuan'} 
...
export default PohonKinerjaOpdView