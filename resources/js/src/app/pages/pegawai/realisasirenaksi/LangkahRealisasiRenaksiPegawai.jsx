...
import { getListRealisasiRenaksiPegawaiLangkah, getListRealisasiRenaksiPegawai, createRealisasiRenaksiPegawaiLangkah } from '@/redux/ducks/realisasirenaksipegawai/action'

const LangkahRealisasiRenaksiPegawai = () => {
    ...
    const getDataTable = () => {
        dispatch(getListRealisasiRenaksiPegawaiLangkah({
    ...
    React.useEffect(() => {
        if(realisasiRenaksiPegawaiState.list.length === 0){ 
            dispatch(getListRealisasiRenaksiPegawai({ tahun: yearActive }))
        }
        else{
            let baseData = null
            let dataSasaran = realisasiRenaksiPegawaiState.list.find((item) => {
    ...
    React.useEffect(() => { initFlowbite() }, [realisasiRenaksiPegawaiState.list_langkah])
    ...
    const renderTable = () => (
        realisasiRenaksiPegawaiState.list_langkah.length > 0 ? realisasiRenaksiPegawaiState.list_langkah.map((item, x) => (
            ...
            <div className="bg-white h-auto dark:bg-gray-800 rounded-lg drop-shadow-xl py-1 px-3 w-full">
                <div className="dark:text-white">
                    <div className="flex flex-row items-center gap-3">
                        ...
                        <div className="lg:text-lg font-bold text-teal-500 dark:text-white">Pengukuran Pegawai</div>
                    </div>
                </div>
            </div>
            <div className="bg-white h-auto dark:bg-gray-800 rounded-lg drop-shadow-xl py-1 sm:px-3 px-1 w-full flex flex-col lg:min-h-[35rem]">
                <div className="block w-full p-4">
                    ...
                    <div className="flex justify-between gap-3">
                        <PrimaryLinkBtn to={`/pegawai/realisasirenaksi`}>
                ...
                <div className="block w-full p-4">
                    ...
                    {
                        !realisasiRenaksiPegawaiState.loading ? renderTable() :
                        <tr className="border-b dark:border-gray-700">
...
export default LangkahRealisasiRenaksiPegawai