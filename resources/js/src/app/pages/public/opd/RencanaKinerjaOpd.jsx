...
import { getPublicVisiPemda, getPublicDaftarOpd, getPublicRencanaKinerjaOpd } from '@/redux/ducks/public/action'
import MySelect2 from '@/app/components/Form/MySelect2'
import { StaticTable } from '@/app/components/Table'

const RencanaKinerjaOpd = () => {
    ...
    React.useEffect(() => {
        if(selectedOpd !== null && selectedYear !== '')
        {
            ...
            dispatch(getPublicRencanaKinerjaOpd(payload))
        }
    ...
    const renderTable = () => {
        return publicDataState.data_rencanakinerja_opd.length > 0 ? publicDataState.data_rencanakinerja_opd.map((item, x) => (
            <>
        ...
        <PublicLayout loading={publicDataState.loading}>
            <div className="w-full px-4 md:py-6 py-2">
                <div className="w-full mx-auto max-w-screen-2xl">
                    <h1 className="font-bold md:text-2xl sm:text-xl text-lg text-primaryWebColor">RENCANA KINERJA PERANGKAT DAERAH</h1>
                </div>
            </div>
            <div className="w-full max-w-screen-2xl min-h-screen bg-white mx-auto border p-4 rounded-lg">
                ...
                <div className="w-full">
                    ...
                    {
                        (publicDataState.data_rencanakinerja_opd === null || selectedOpd === null || selectedYear === '') ? 
                        <tr className="border-b dark:border-gray-700">
...
export default RencanaKinerjaOpd