...
const AnalisisKinerjaOpd = () => {
    ...
    return (
        <Layout loading={realisasiRenaksiOpdState.loading}>
                    ...
                    <StaticTable header={tableHeader()}>
                    {
                        ...
                        realisasiRenaksiOpdState.list.map((item, key) => (
                            ...
                            <tr key={key} className="border-b dark:border-gray-700">
                                ...
                                <td className="px-4 py-3 border">(belum ada data)</td>
                                <td className="px-4 py-3 border">{item.indikator_sasaran[0]?.rencana_aksi?.hambatan ?? '(No Data)'}</td>
                                <td className="px-4 py-3 border">{item.indikator_sasaran[0]?.rencana_aksi?.tindak_lanjut ?? '(No Data)'}</td>
                            </tr>
                            {
...
export default AnalisisKinerjaOpd