...
import { getListPelaporanCapaianKinerjaKdh } from '@/redux/ducks/pelaporankdh/action'
import Swal from 'sweetalert2'
import { alphaNumeric } from '@/app/helper/Common'

const CapaianKinerjaKdh = () => {
    const dispatch = useDispatch()
    const pelaporanKdhState = useSelector((state) => state.pelaporanKdhState)
    const getDataTable = async (tahun = "") => {
        let response = await dispatch(getListPelaporanCapaianKinerjaKdh({ tahun: tahun == "" ? selectedYear : tahun }))
    ...
    return (
        <Layout loading={pelaporanKdhState.loading}>
            ...
            <div className="bg-white h-auto dark:bg-gray-800 rounded-lg drop-shadow-xl py-1 sm:px-3 px-1 w-full flex flex-col lg:min-h-[35rem]">
                ...
                <div className="block w-full p-4">
                    ...
                    {
                        pelaporanKdhState.loading ? 
                        <tr className="border-b dark:border-gray-700">
                            <td colSpan="100%" className="px-4 py-3 border text-center">Loading...</td>
                        </tr> : (
                            pelaporanKdhState.capaian_kinerja.length > 0 ?  
                            renderTujuan(pelaporanKdhState.capaian_kinerja)
                            :
                            <tr className="border-b dark:border-gray-700">
                                <td colSpan="100%" className="px-4 py-3 border text-center">No Data</td>
                            </tr>
...
export default CapaianKinerjaKdh