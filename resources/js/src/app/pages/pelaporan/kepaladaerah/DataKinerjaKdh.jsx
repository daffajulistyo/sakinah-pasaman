...
import { getListPelaporanDataKinerjaKdh } from '@/redux/ducks/pelaporankdh/action'
import Swal from 'sweetalert2'
import { alphaNumeric } from '@/app/helper/Common'

const DataKinerjaKdh = () => {
    const dispatch = useDispatch()
    const pelaporanKdhState = useSelector((state) => state.pelaporanKdhState)
    const getDataTable = async () => {
        let response = await dispatch(getListPelaporanDataKinerjaKdh())
                ...
                <div className="block w-full p-4">
                    <StaticTable header={tableHeader()}>
                    {
                        ...
                        <tr className="border-b dark:border-gray-700">
                            ...
                            pelaporanKdhState.data_kinerja.length > 0 ?  
                            renderTujuan(pelaporanKdhState.data_kinerja)
                            :
                            <tr className="border-b dark:border-gray-700">
                                <td colSpan="100%" className="px-4 py-3 border text-center">No Data</td>
                            </tr>
