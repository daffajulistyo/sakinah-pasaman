        ...
        <div className="bg-white h-auto dark:bg-gray-800 rounded-lg drop-shadow-xl py-1 px-3 w-full">
            <div className="dark:text-white flex w-full justify-between">
                ...
                <div className="flex p-2">
                    <Link to={'/perencanaan/opd/pohonkinerja/view'} className="flex flex-row items-center gap-3 bg-lime-600 dark:bg-lime-800 sm:px-5 px-1.5 sm:p-0.5 p-1 rounded-lg hover:bg-lime-700 dark:hover:bg-lime-900">
                        <div>
...
export default HeaderPohonKinerjaOpd