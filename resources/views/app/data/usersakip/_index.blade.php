...
@section('title', ' | User SAKINAH')

@section('content')
<h3 class="text-gray-700 text-3xl font-medium">User Sakip</h3>
<div class="container bg-white p-10 my-10" x-data="userCrud()">
    ...
    <x-modal :value="1">
        ...
        <div class="border-b-2 border-black mb-4">
            <h2 class="text-3xl font-medium" :id="$id('modal-title')">Form Data User Sakip</h2>
        </div>
        <!-- Content -->
        <form action="#" @submit.prevent="confirmSave">
            <div class="flex flex-wrap -mx-3 mb-6">
                ...
                <div class="w-full px-3 my-3">
                    ...
                    <select name="roles" x-model="form.roles"
                ...
                <div class="w-full px-3 my-3" x-show="opdReq()">
                    <label class="block tracking-wide text-gray-700 text-sm font-bold mb-2" for="opd_id">
                        Perangkat Daerah (OPD)
                    </label>
                    <select name="opd_id" x-model="form.opd_id"
                    class="w-full h-9 text-base text-gray-700 placeholder-gray-300 border rounded-lg focus:shadow-outline" 
                    type="text" id="opdSelect"
                    placeholder="Pilih Perangkat Daerah..." x-init="getOpd()">
                    </select>
                    <small x-text="errMsg.opd_id" class="ml-3 text-xs text-red-500"></small>
                </div>
                <div class="w-full px-3 my-3">
...
@section('_inJs')
@include('app.data.usersakip._inJs')
@endsection
<!-- /Your Custom Javascript -->