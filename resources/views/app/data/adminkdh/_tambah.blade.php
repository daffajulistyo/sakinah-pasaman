...
@section('title', ' | Tambah Admin Kepala Daerah')

@section('content')
<h3 class="text-gray-700 text-3xl font-medium">Tambah Admin Kepala Daerah</h3>
...
@section('_inJs')
@include('app.data.adminkdh._inJsTambah')
@endsection
<!-- /Your Custom Javascript -->