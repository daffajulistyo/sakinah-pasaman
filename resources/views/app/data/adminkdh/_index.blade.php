...
@section('title', ' | ADMIN KEPALA DAERAH')

@section('content')
<h3 class="text-gray-700 text-3xl font-medium">Data Admin Kepala Daerah</h3>
...
@section('_inJs')
@include('app.data.adminkdh._inJs')
@endsection
<!-- /Your Custom Javascript -->