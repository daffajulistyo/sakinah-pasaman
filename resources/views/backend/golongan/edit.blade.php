...
<div class="d-flex justify-content-between align-items-center mb-3">
    <h5 class="fw-bold mb-0">Edit Golongan</h5>
    ...
    <div class="card-body p-4">
        <form action="{{ route('golongan.update', $item->id) }}" method="POST">
            ...
            <div class="mb-3">
                ...
                <input type="text" name="golongan" id="golongan" class="form-control @error('golongan') is-invalid @enderror" value="{{ old('golongan', $item->golongan) }}" placeholder="Masukkan golongan">
                @error('golongan') <div class="invalid-feedback">{{ $message }}</div> @enderror
            </div>

            <div class="mb-3">
                <label for="pangkat" class="form-label">Pangkat</label>
                <input type="text" name="pangkat" id="pangkat" class="form-control @error('pangkat') is-invalid @enderror" value="{{ old('pangkat', $item->pangkat) }}" placeholder="Masukkan pangkat">
