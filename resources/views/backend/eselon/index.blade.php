...
@section('page-title', 'Master Eselon')
@section('main-content')

<div class="card">
    <div class="card-header d-flex justify-content-between align-items-center">
        <h3 class="card-title mb-0">Master Eselon</h3>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="text-center">
                            ...
                            <button class="btn btn-sm btn-outline-danger btn-sm-table" title="Hapus" data-bs-toggle="modal" data-bs-target="#deleteModal" data-action="{{ route('eselon.destroy', $row->id) }}"><i class="bi bi-trash"></i></button>
                        </td>
                    </tr>
                    @empty
        ...
        <div class="modal-content">
            <form id="formModalForm" method="POST">
                ...
                <div class="modal-header">
                    <h6 class="modal-title" id="formModalTitle">Tambah Eselon</h6>
                ...
                <div class="modal-body">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="number" name="level" id="level" class="form-control form-control-sm" required>
                    </div>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    formModal.addEventListener('show.bs.modal', function(e) {
        ...
        if (mode === 'edit') {
            title.textContent = 'Edit Eselon';
            frm.action = '{{ url("backend/eselon") }}/' + btn.getAttribute('data-id');
            method.value = 'PUT';
            ...
            document.getElementById('level').value = btn.getAttribute('data-level');
            document.getElementById('is_active').checked = btn.getAttribute('data-aktif') == '1';
        } else {
            title.textContent = 'Tambah Eselon';
            frm.action = '{{ route("eselon.store") }}';
            method.value = 'POST';
            frm.reset();
