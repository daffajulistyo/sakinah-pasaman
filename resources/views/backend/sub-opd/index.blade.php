...
@section('page-title', 'Master Sub OPD')
@section('main-content')

<div class="card">
    <div class="card-header d-flex justify-content-between align-items-center">
        <h3 class="card-title mb-0">Master Sub OPD</h3>
    ...
    <div class="card-body">
        <div class="mb-3">
            <form method="GET" class="row g-2">
                ...
                @if($search)<div class="col-auto"><a href="{{ route('sub-opd.index') }}" class="btn btn-sm btn-outline-danger">&times; Reset</a></div>@endif
            </form>
        </div>
