...
<div class="d-flex justify-content-between align-items-center mb-3">
    <h5 class="fw-bold mb-0">Tambah OPD</h5>
    ...
    <div class="card-body p-4">
        <form action="{{ route('opd.store') }}" method="POST">
            ...
            <div class="mb-3">
                ...
                <input type="text" name="kode_opd" id="kode_opd" class="form-control @error('kode_opd') is-invalid @enderror" value="{{ old('kode_opd') }}" placeholder="Masukkan kode OPD">
                @error('kode_opd') <div class="invalid-feedback">{{ $message }}</div> @enderror
            </div>

            <div class="mb-3">
                <label for="nama_opd" class="form-label">Nama OPD</label>
                <input type="text" name="nama_opd" id="nama_opd" class="form-control @error('nama_opd') is-invalid @enderror" value="{{ old('nama_opd') }}" placeholder="Masukkan nama OPD">
            ...
            <div class="mb-3">
                ...
                <input type="text" name="telp" id="telp" class="form-control @error('telp') is-invalid @enderror" value="{{ old('telp') }}" placeholder="Masukkan nomor telepon">
            ...
            <div class="mb-3">
                ...
                <input type="url" name="website" id="website" class="form-control @error('website') is-invalid @enderror" value="{{ old('website') }}" placeholder="Masukkan URL website">
