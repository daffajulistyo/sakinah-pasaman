...
<div class="d-flex justify-content-between align-items-center mb-3">
    ...
    <a href="{{ route('opd.create') }}" class="btn btn-sm btn-primary"><i class="bi bi-plus-lg me-1"></i> Tambah</a>
</div>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="text-center">
                            <a href="{{ route('opd.edit', $row->id) }}" class="btn btn-sm btn-outline-primary btn-sm-table" title="Edit"><i class="bi bi-pencil"></i></a>
                            <button class="btn btn-sm btn-outline-danger btn-sm-table" title="Hapus" data-bs-toggle="modal" data-bs-target="#deleteModal-opd" data-action="{{ route('opd.destroy', $row->id) }}"><i class="bi bi-trash"></i></button>
                        </td>
                    </tr>
                    @empty
...
{{-- Delete Modal --}}
<div class="modal fade" id="deleteModal-opd" tabindex="-1">
    <div class="modal-dialog modal-sm modal-dialog-centered">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <form id="deleteForm-opd" method="POST">@csrf @method('DELETE')<button class="btn btn-sm btn-danger">Hapus</button></form>
            </div>
        </div>
    </div>
</div>
@push('scripts')
<script>
    const deleteModalOpd = document.getElementById('deleteModal-opd');
    deleteModalOpd.addEventListener('show.bs.modal', function(e) { document.getElementById('deleteForm-opd').action = e.relatedTarget.getAttribute('data-action'); });
</script>
@endpush
@endsection
