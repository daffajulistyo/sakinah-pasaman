...
<div class="d-flex justify-content-between align-items-center mb-3">
    <h5 class="fw-bold mb-0">Master Pegawai</h5>
    <a href="{{ route('pegawai.create') }}" class="btn btn-sm btn-primary"><i class="bi bi-plus-lg me-1"></i> Tambah</a>
</div>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="text-center">
                            <a href="{{ route('pegawai.edit', $row->id) }}" class="btn btn-sm btn-outline-primary btn-sm-table" title="Edit"><i class="bi bi-pencil"></i></a>
                            <button class="btn btn-sm btn-outline-danger btn-sm-table" title="Hapus" data-bs-toggle="modal" data-bs-target="#deleteModal-pegawai" data-action="{{ route('pegawai.destroy', $row->id) }}"><i class="bi bi-trash"></i></button>
                        </td>
                    </tr>
                    @empty
...
{{-- Delete Modal --}}
<div class="modal fade" id="deleteModal-pegawai" tabindex="-1">
    <div class="modal-dialog modal-sm modal-dialog-centered">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <form id="deleteForm-pegawai" method="POST">@csrf @method('DELETE')<button class="btn btn-sm btn-danger">Hapus</button></form>
            </div>
        </div>
    </div>
</div>
@push('scripts')
<script>
    const deleteModalPegawai = document.getElementById('deleteModal-pegawai');
    deleteModalPegawai.addEventListener('show.bs.modal', function(e) { document.getElementById('deleteForm-pegawai').action = e.relatedTarget.getAttribute('data-action'); });
</script>
@endpush
@endsection
