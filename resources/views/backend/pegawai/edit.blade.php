        ...
        <form action="{{ route('pegawai.update', $item->id) }}" method="POST">
            ...
            <div class="row">
                ...
                <div class="col-md-6 mb-3">
                    ...
                    <input type="text" name="gelar_depan" id="gelar_depan" class="form-control @error('gelar_depan') is-invalid @enderror" value="{{ old('gelar_depan', $item->gelar_depan) }}" placeholder="Masukkan gelar depan">
                ...
                <div class="col-md-6 mb-3">
                    ...
                    <input type="text" name="gelar_belakang" id="gelar_belakang" class="form-control @error('gelar_belakang') is-invalid @enderror" value="{{ old('gelar_belakang', $item->gelar_belakang) }}" placeholder="Masukkan gelar belakang">
                ...
                <div class="col-md-6 mb-3">
                    ...
                    <input type="text" name="tempat_lahir" id="tempat_lahir" class="form-control @error('tempat_lahir') is-invalid @enderror" value="{{ old('tempat_lahir', $item->tempat_lahir) }}" placeholder="Masukkan tempat lahir">
                    @error('tempat_lahir') <div class="invalid-feedback">{{ $message }}</div> @enderror
                </div>

                <div class="col-md-6 mb-3">
                    <label for="tanggal_lahir" class="form-label">Tanggal Lahir (Opsional)</label>
                    <input type="date" name="tanggal_lahir" id="tanggal_lahir" class="form-control @error('tanggal_lahir') is-invalid @enderror" value="{{ old('tanggal_lahir', $item->tanggal_lahir ? \Carbon\Carbon::parse($item->tanggal_lahir)->format('Y-m-d') : '') }}">
                ...
                <div class="col-md-6 mb-3">
                    ...
                    <input type="text" name="no_hp" id="no_hp" class="form-control @error('no_hp') is-invalid @enderror" value="{{ old('no_hp', $item->no_hp) }}" placeholder="Masukkan nomor HP">
                ...
                <div class="col-md-6 mb-3">
                    ...
                    <select name="eselon_id" id="eselon_id" class="form-select @error('eselon_id') is-invalid @enderror">
                        ...
                        @foreach($eselons as $es)
                            <option value="{{ $es->id }}" {{ old('eselon_id', $item->ref_eselon_id) == $es->id ? 'selected' : '' }}>{{ $es->nama }}</option>
                        @endforeach
                    </select>
                ...
                <div class="col-md-6 mb-3">
                    ...
                    <select name="golongan_id" id="golongan_id" class="form-select @error('golongan_id') is-invalid @enderror">
                        ...
                        @foreach($golongans as $gol)
                            <option value="{{ $gol->id }}" {{ old('golongan_id', $item->ref_golongan_id) == $gol->id ? 'selected' : '' }}>{{ $gol->golongan }} - {{ $gol->pangkat }}</option>
                        @endforeach
                    </select>
                ...
                <div class="col-md-6 mb-3">
                    ...
                    <select name="jenis_jabatan_id" id="jenis_jabatan_id" class="form-select @error('jenis_jabatan_id') is-invalid @enderror">
                        ...
                        @foreach($jenisJabatans as $jj)
                            <option value="{{ $jj->id }}" {{ old('jenis_jabatan_id', $item->ref_jenis_jabatan_id) == $jj->id ? 'selected' : '' }}>{{ $jj->nama }}</option>
                        @endforeach
                    </select>
                ...
                <div class="col-md-6 mb-3">
                    ...
                    <select name="jabatan_id" id="jabatan_id" class="form-select @error('jabatan_id') is-invalid @enderror">
                        ...
                        @foreach($jabatans as $jab)
                            <option value="{{ $jab->id }}" {{ old('jabatan_id', $item->ref_jabatan_id) == $jab->id ? 'selected' : '' }}>{{ $jab->nama }}</option>
                        @endforeach
                    </select>
                ...
                <div class="col-md-6 mb-3">
                    ...
                    <input type="text" name="jenjang" id="jenjang" class="form-control @error('jenjang') is-invalid @enderror" value="{{ old('jenjang', $item->jenjang) }}" placeholder="Masukkan jenjang">
