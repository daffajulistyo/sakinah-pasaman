...
<body>
    <h2 style="text-align:center;">REALISASI KINERJA PEGAWAI</h2>
    ...
    <table class="report">
        <thead>
            ...
            <tr >
                <th colspan="19" style="background-color:#DEEBF7;" align="left"> Hasil Kerja </th>
            </tr>   
            <tr>
                <th class="col-no" rowspan="3" width="5%">No</th>
                <th rowspan="3" width="25%">Sasaran Kerja Pimpinan Yang Diintervensi</th>
                <th rowspan="3" width="30%" class="col-code" >Sasaran Kerja Pegawai</th>
                <th rowspan="3" width="30%"  class="col-code">Indikator Kinerja Individu</th>
                <th colspan="12" width="10%">Target</th>
                <th rowspan="3" width="10%">Aksi</th>
                <th rowspan="3" width="10%">Hambatan</th>
                <th rowspan="3" width="10%">Tindak Lanjut</th>
            </tr>
            <!-- header baris 2 -->
            <tr>
                <th colspan="3">TW1</th>
                            ...
                            <td rowspan="{{ $inside_rows }}"> {{ $sp['sasaran'] }}</td>
                               @php $x=0; @endphp
                                @foreach($sp['indikator'] as $di)
                                    ...
                                    @if($x==1)
                                    <td> {{ $di['indikator'] }}</td>                          
                                    <td> {{ !empty($di['target_tw1']) ? $di['target_tw1'] : '' }}</td>
                                    <td> {{ !empty($di['realisasi_tw1']) ? $di['realisasi_tw1'] : '' }}</td>
                                    <td> {{ !empty($di['capaian_tw1']) ? $di['capaian_tw1'] : '' }}</td>

                                    <td> {{ !empty($di['target_tw2']) ? $di['target_tw2'] : '' }}</td>
                                    <td> {{ !empty($di['realisasi_tw2']) ? $di['realisasi_tw2'] : '' }}</td>
                                    <td> {{ !empty($di['capaian_tw2']) ? $di['capaian_tw2'] : '' }}</td>

                                    <td> {{ !empty($di['target_tw3']) ? $di['target_tw3'] : '' }}</td>
                                    <td> {{ !empty($di['realisasi_tw3']) ? $di['realisasi_tw3'] : '' }}</td>
                                    <td> {{ !empty($di['capaian_tw3']) ? $di['capaian_tw3'] : '' }}</td>

                                    <td> {{ !empty($di['target_tw4']) ? $di['target_tw4'] : '' }}</td>
                                    <td> {{ !empty($di['realisasi_tw4']) ? $di['realisasi_tw4'] : '' }}</td>
                                    <td> {{ !empty($di['capaian_tw4']) ? $di['capaian_tw4'] : '' }}</td>                                    
                                    <td>
                                    ...
                                    <td> {{ !empty($di['hambatan']) ? $di['hambatan'] : '' }}</td>
                                    <td> {{ !empty($di['tindak_lanjut']) ? $di['tindak_lanjut'] : '' }}</td>
                                    @else
                                    <tr>
                                        <td>{{ $di['indikator'] }}</td>
                                        <td> {{ !empty($di['target_tw1']) ? $di['target_tw1'] : '' }}</td>
