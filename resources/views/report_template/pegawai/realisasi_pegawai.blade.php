...
<body>
    <h2 style="text-align:center;">Realisasi Rencana Aksi Pegawai</h2>
        ...
        <tbody>
            ...
            @foreach($data['sasaran'] as $node)
                <tr>
                    ...
                    <td>{{ @$node['indikator_sasaran'][0]['rencana_aksi']['langkah'] ?? '' }}</td>
                    <td>{{ @$node['indikator_sasaran'][0]['rencana_aksi']['anggaran'] ?? '' }}</td>
                ...
                <tr>
                    ...
                    <td>{{ @$ind['rencana_aksi']['langkah'] ?? '' }}</td>
                    <td>{{ @$ind['rencana_aksi']['anggaran'] ?? '' }}</td>
